    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="border: 1px solid #dee2e6; border-top: none; padding: 20px; border-radius: 0 0 8px 8px;">
        ...
        <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #dee2e6;">
          <a href="https://automated-regulatory-and-compliance-bjn0.onrender.com" style="background: #0d6efd; color: white; padding: 10px 20px; border-radius: 4px; text-decoration: none; font-weight: bold;">Open Dashboard</a>
        </div>
